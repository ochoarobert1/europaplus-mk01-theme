<form role="search" method="get" id="searchform" class="searchform" action="<?php echo home_url( '/' ); ?>">
    <label for="s" class="screen-reader-text"><?php _e('¿Cómo Podemos Ayudarte?', 'europaplus'); ?></label>
    <div class="input-group mb-3">
        <select name="s" id="s" class="form-control flexselect" placeholder="<?php _e('Ingresa términos de busqueda aquí', 'europaplus'); ?>">
