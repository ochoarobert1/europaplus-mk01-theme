...
function europaplus_load_css() {
    ...
    if (!is_admin()){
        ...
        /*- MAIN MEDIAQUERIES -*/
        wp_register_style('main-mediaqueries', get_template_directory_uri() . '/css/europaplus-mediaqueries.css', array('main-style'), $version_remove, 'all');
...
add_action('wp_enqueue_scripts', 'europaplus_load_css');
