        ...
        <div class="single-main-container single-main-help-container col-12" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
            <div class="container">
                <div class="row">
                    ...
                    <div class="single-main-help-menu col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                        <div class="row">
                    ...
                    <div class="single-main-help-content col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                        <h1><?php the_title(); ?></h1>
